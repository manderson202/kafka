...
public final class ConsumerRecord<K, V> {
    ...
    // TODO: Update assignments when support for below fields is added in mapr-streams
    //   `timestampType`, `checksum`, `serializedKeySize`, `serializedValueSize`
    /**
     * Creates a record to be received from a specified topic and partition
     *
     * @param topic The topic this record is received from
    ...
    public ConsumerRecord(String topic,
        ...
        this.serializedKeySize = NULL_SIZE;
        this.serializedValueSize = NULL_SIZE;
    ...
    public String toString() {
        return "ConsumerRecord(topic = " + topic() + ", partition = " + partition() + ", offset = " + offset()
                ...
                + ", key = " + key + ", value = " + value + ", producer =" + producer + ")";
    }
}
